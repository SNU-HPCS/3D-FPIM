...
int main() {
    ...
    unsigned int out_size_x1 = 224;
    unsigned int out_size_y1 = 224;
    ...
    // Layer 14 (FC layer) configuration
    ...
    // Layer 15 (FC layer) configuration
    ...
    // Layer 16 (FC layer) configuration
    ...
    auto out7 = convmax_layer(model, "conv07", k_size_x7, k_size_y7, in_size_x7, in_size_y7, in_channels7, out_channels7, stride7, out_size_x7, out_size_y7, max_pool_size_x7, max_pool_size_y7, out6, /*is_pool*/true);
    ...
    auto out10 = convmax_layer(model, "conv10", k_size_x10, k_size_y10, in_size_x10, in_size_y10, in_channels10, out_channels10, stride10, out_size_x10, out_size_y10, max_pool_size_x10, max_pool_size_y10, out9, /*is_pool*/true);
    ...
    auto out13 = convmax_layer(model, "conv13", k_size_x13, k_size_y13, in_size_x13, in_size_y13, in_channels13, out_channels13, stride13, out_size_x13, out_size_y13, max_pool_size_x13, max_pool_size_y13, out12, /*is_pool*/true);
