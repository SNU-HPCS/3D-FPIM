...
int main() {
    ...
    Model model = Model::create("resnet18");
    ...
    // Layer 2 (residual block (Basic)) configurations
    ...
    unsigned int block_num2 = 2;

    // Layer 3 (convolution with max pool) configurations
    ...
    balance_basic_block(model, in_size_x2, in_size_y2, in_channels2,
        out_size_x2, out_size_y2, out_channels2, stride2, block_num2);
    balance_basic_block(model, in_size_x3, in_size_y3, in_channels3,
        out_size_x3, out_size_y3, out_channels3, stride3, block_num3);
    balance_basic_block(model, in_size_x4, in_size_y4, in_channels4,
        out_size_x4, out_size_y4, out_channels4, stride4, block_num4);
    balance_basic_block(model, in_size_x5, in_size_y5, in_channels5,
    ...
    auto out2 = basic_block(model, "conv2", in_size_x2, in_size_y2, in_channels2, out_size_x2, out_size_y2, out_channels2, stride2, block_num2, maxpool(out1, max_pool_size_x1, max_pool_size_y1));
    auto out3 = basic_block(model, "conv3", in_size_x3, in_size_y3, in_channels3, out_size_x3, out_size_y3, out_channels3, stride3, block_num3, out2);
    auto out4 = basic_block(model, "conv4", in_size_x4, in_size_y4, in_channels4, out_size_x4, out_size_y4, out_channels4, stride4, block_num4, out3);
    auto out5 = basic_block(model, "conv5", in_size_x5, in_size_y5, in_channels5, out_size_x5, out_size_y5, out_channels5, stride5, block_num5, out4);
